    ...
    with open(folder+'All.eval', 'w') as allFile:
        ...
        for systemID, results in systemResults.iteritems():
            ...
            with open(folder+filename, 'w') as output:
                ...
                output.write('{}\t{:.3f}\t{:.3f}\t{:.3f}\t{:.3f}\t{:.3f}\t{:.3f}\n'.format("mean", np.mean(systemPrecision.values()), np.mean(systemRecall.values()), np.mean(systemPrecision.values()), np.mean(average_precision.values()), np.mean(nDCG10.values()), np.mean(nDCG20.values())))

            allFile.write('{}\t{:.3f}\t{:.3f}\t{:.3f}\t{:.3f}\t{:.3f}\t{:.3f}\n'.format("S"+str(systemID), np.mean(systemPrecision.values()), np.mean(systemRecall.values()), np.mean(systemPrecision.values()), np.mean(average_precision.values()), np.mean(nDCG10.values()), np.mean(nDCG20.values())))
